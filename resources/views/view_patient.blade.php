                ...
                <h6 class="   p-2 mb-1 d-flex justify-content-center bg-blue-grey custom-border-radius">Patient's Profile</h6>
                    <div class="complete">
                        <div class="p-header">
                            ...
                            @else
                            <img src="{{url('public/uploads/patient/'.$patient->image)}}" class="doctor-profile my-4">
                            @endif
                            ...
                            <div class="col-md-4 p-0 pt-3 pe-1">
                                <div class="treatment-card d-flex flex-column flex-wrap">
                                    <div class="treatment-card-details">
                                        ...
                                        <p class="fw-bold m-0 ms-1 mt-1 mb-2">{{$treatment_info->treatment_plans}}</p>
                                    ...
                                    <div class="treatment-card-btn">
                                        <a href="{{route('treatments',[$doctor_info->id,$patient->id,$treatment_info->id,$treatment_info->treatment_plans])}}" class="py-1" style="font-size: 20px;color: #000;">Enter</a>
                                    </div>
                                </div>
                            </div>
                            @endforeach
                                                    ...
                                                    <form action="{{route('update_patient',$patient->id)}}" method="post">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-2 col-6">
                                                                ...
                                                                <div class="d-flex">
                                                                    <input type="number" name="bp_high" class="form-control custom-form-control me-3" value="{{$patient->bp_high}}">
                                                                    <h3 class="m-0">/</h3>
                                                                    <input type="number" name="bp_low" class="form-control custom-form-control ms-3" value="{{$patient->bp_low}}">
                                                                </div>
                                                            ...
                                                            <div class="mb-2 col-6">
                                                                ...
                                                                <select class="form-select" name="Bleeding_disorder" aria-label="Heart Disease" value="{{$patient->Bleeding_disorder}}">
                                                                    ...
                                                                    <option {{($patient->Bleeding_disorder) == 'yes' ? 'selected' : ''}} value="yes">Yes</option>
                                                                    <option {{($patient->Bleeding_disorder) == 'no' ? 'selected' : ''}} value="no">No</option>
                                                            ...
                                                            <div class="mb-2 col-6">
                                                                ...
                                                                <select class="form-select" name="Heart_Disease" aria-label="Heart Disease" value="{{$patient->Heart_Disease}}">
                                                                    <option selected></option>
                                                                    <option {{($patient->Heart_Disease) == 'yes' ? 'selected' : ''}} value="yes">Yes</option>
                                                                    <option {{($patient->Heart_Disease) == 'no' ? 'selected' : ''}} value="no">No</option>
                                                                    <!-- <option value="3">Others</option> -->
                                                                </select>
                                                            </div>
                                                            <!-- 4 -->
                                                            <div class="mb-2 col-6">
                                                                ...
                                                                <select class="form-select" name="Allergy" aria-label="Heart Disease" value="{{$patient->Allergy}}">
                                                                    <option selected></option>
                                                                    <option {{($patient->Allergy) == 'yes' ? 'selected' : ''}} value="yes">Yes</option>
                                                                    <option {{($patient->Allergy) == 'no' ? 'selected' : ''}} value="no">No</option>
                                                                    <!-- <option value="3">Others</option> -->
                                                                </select>
                                                            </div>
                                                            <!-- 5 -->
                                                            <div class="mb-2 col-6">
                                                                ...
                                                                <select class="form-select" name="Diabetic" aria-label="Heart Disease" value="{{$patient->Diabetic}}">
                                                                    <option selected></option>
                                                                    <option {{($patient->Diabetic) == 'yes' ? 'selected' : ''}} value="yes">Yes</option>
                                                                    <option {{($patient->Diabetic) == 'no' ? 'selected' : ''}} value="no">No</option>
                                                                    <!-- <option value="3">Others</option> -->
                                                                </select>
                                                            </div>
                                                            <!-- 6 -->
                                ...
                                @else
                                                            <div class="mb-2 col-6">
                                                                ...
                                                                <select class="form-select" name="Pregnant" aria-label="Heart Disease" value="{{$patient->Pregnant}}">
                                                                    <option selected></option>
                                                                    <option {{($patient->Pregnant) == 'yes' ? 'selected' : ''}} value="yes">Yes</option>
                                                                    <option {{($patient->Pregnant) == 'no' ? 'selected' : ''}} value="no">No</option>
                                                                    <!-- <option value="3">Others</option> -->
                                                                </select>
                                                            </div>
                                @endif
                                                            ...
                                                            <div class="mb-2 col-6">
                                                                ...
                                                                <select class="form-select" name="Helpatics" aria-label="Heart Disease" value="{{$patient->Helpatics}}">
                                                                    <option selected></option>
                                                                    <option {{($patient->Helpatics) == 'yes' ? 'selected' : ''}} value="yes">Yes</option>
                                                                    <option {{($patient->Helpatics) == 'no' ? 'selected' : ''}} value="no">No</option>
                                                                    <!-- <option value="3">Others</option> -->
                                                                </select>
                                                            </div>
                                                            <!-- 8 -->
                                                            <div class="mb-2 col-6">
                                                                ...
                                                                <input type="text" name="other" class="form-control custom-form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$patient->other}}">
                                                            </div>
                                                        </div>
