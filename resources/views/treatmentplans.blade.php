                                ...
                                <div class="col-md-6 ">
                                    <div class="container">
                                        <div class="treatment-info mb-2 ">
                                            <img class="tooth-img"
                                                 src="{{ asset('assets/img/teeths/all_tooth/'.$tooth_info->img)}}"
                                                 alt="">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-6">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="treatment-box p-2">
                                    <p class="fw-bold m-0 ms-1">CC : <span
                                            class="fw-normal">{{$treatment_info->chife_complaints}}</span></p>
                                    <p class="fw-bold m-0 ms-1">CF : <span
                                            class="fw-normal">{{$treatment_info->clinical_findings}}</span></p>
                                    <p class="fw-bold m-0 ms-1 mb-2">Investigation : <span
                                            class="fw-normal">{{$treatment_info->investigation}}</span></p>
                                </div>
                            </div>
                            <div class="col-12 mt-1">
                                ...
                                <form
                                    action="{{route('treatment_steps',[$doctor_info->id,$patient->id,$treatment_info->id])}}"
                                    method="post">
                                    @csrf
                                    <div class="treatment-box p-2">
                                        ...
                                        <select class="form-select" aria-label="Default select example" id="t_status"
                                                name="t_status">
                                            <option {{($treatment_info->status) == '0' ? 'selected' : ''}} value="0">Not
                                                Done
                                            </option>
                                            <option {{($treatment_info->status) == '1' ? 'selected' : ''}} value="1">
                                                Progress
                                            </option>
                                            <option {{($treatment_info->status) == '2' ? 'selected' : ''}} value="2">
                                                Done
                                            </option>
                                        </select>
                                    ...
                                    <table class="table table-bordered text-center">
                                        ...
                                        @foreach($reports as $key=>$report)
                                            <tr>
                                                <td>{{$key + 1}}</td>
                                                <td>
                                                    <img src="{{url('public/uploads/report/'.$report->image)}}"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('next_appointment')}}" method="post">
                    ...
                    @method('PUT')
                    <div class="modal-body">
                        <input type="hidden" id="appointment_id" value="{{$appointment_id}}" name="appointment_id">
...
<div class="modal fade " id="Report_Add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <!-- Modal Body -->
            <div class="modal-body">
                <form action="{{route('report',[$doctor_info->id,$patient->id,$treatment_info->id])}}" method="post"
