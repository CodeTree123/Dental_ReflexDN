        ...
        <section class="prescription-header">
            <div class="container">
                <div class="d-flex justify-content-between">
                    <div class="mb-3">
                        <h5 class="docname">{{$doctor_info->fname." ".$doctor_info->lname}}</h5>
                        <ul class="list-unstyled">
                            <li>
                                <p class="deg2">{{$doctor_info->designation}}</p>
                            </li>
                            <li>
                                <p class="bmdcnum">BMDC no: {{$doctor_info->BMDC}}</p>
                            </li>
                            <li>
                                <p class="deg2">{{$doctor_info->bDegree}}</p>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        @else
                            <img src="{{asset ('uploads/Barcode/'.$doctor_info->bar_image)}}" alt="Qr" class="img-fluid" width="100" height="100">
                        @endif
                    </div>
                    <div class="date w-25">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-borderless">
                        ...
                        <tr class="">
                            ...
                            <td class=" "><span class="title">Next Appointment : {{$patient->address}}</span> <span class="value pres_pt_address"></span></td>
                        </tr>
                    </table>
                </div>
            </div>
                        ...
                        <div class="left">
                            <div class="single cc">
                                <h2>C/C:</h2>
                                    ...
                                    <!-- <input type="text" value="38" id="hidden_teeth_number" readonly>F -->
                                    ...
                                    <ol class="ms-5">
                                        @foreach($treatment_infos as $key=>$treatment_info)
                                            <li class="d-flex justify-content-between">
                                                <span>{{$key + 1}}. {{$treatment_info->clinical_findings}}</span>
                                                <span>{{$treatment_info->tooth_no}}</span>
                                            </li>
                                        @endforeach
                                    </ol>
                                    <!--<table class="tb" >-->
                            ...
                            <div class="single tp">
                                ...
                                <div class="complain">
                                    ...
                                    <ol class="ms-5">
                                        @foreach($treatment_infos as $key=>$treatment_info)
                                            <li class="d-flex justify-content-between">
                                            <span>{{$key + 1}}. {{$treatment_info->treatment_plans}}</span>
                                            <span>{{$treatment_info->tooth_no}}</span>
                                            </li>
                                        @endforeach
                                    </ol>
                            ...
                            <div class="single investigation">
                                ...
                                <div class="complain">
                                    ...
                                    <ol class="ms-5">
                                        @foreach($treatment_infos as $key=>$treatment_info)
                                        <li class="d-flex justify-content-between">
                                            <span>{{$key + 1}}. {{$treatment_info->investigation}}</span>
                                            <span>{{$treatment_info->tooth_no}}</span>
                                        </li>
                                        @endforeach
                                    </ol>
            ...
            <form action="{{route('add_drug',[$doctor_info->id,$patient->id])}}" method="post">
                ...
                <div class="modal-body">
                    <div class="mb-3 drug-name">
                        <select class="form-select" name="drug_name" value="">
...
<div class="modal fade" id="p_submit">
    <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('prescription_add',[$doctor_info->id])}}" method="post">
                @csrf
