                ...
                <div class="d-flex justify-content-between">
                    <div class="mb-3">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <p class="deg2"><?php echo e($doctor_info->designation); ?></p>
                            </li>
                            <li>
                                <p class="bmdcnum">BMDC no: <?php echo e($doctor_info->BMDC); ?></p>
                            </li>
                            <li>
                                <p class="deg2"><?php echo e($doctor_info->bDegree); ?></p>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <?php else: ?>
                            <img src="<?php echo e(asset ('uploads/Barcode/'.$doctor_info->bar_image)); ?>" alt="Qr" class="img-fluid" width="100" height="100">
                        <?php endif; ?>
                    </div>
                    <div class="date w-25">
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-borderless">
                        ...
                        <tr class="">
                            ...
                            <td class=" "><span class="title">Next Appointment : <?php echo e($patient->address); ?></span> <span class="value pres_pt_address"></span></td>
                        </tr>
                    </table>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\reflexdn\resources\views/prescription.blade.php ENDPATH**/ ?>