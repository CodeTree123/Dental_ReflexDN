...
<div class="page-content  px-5 ">
    <div class="page-header d-flex justify-content-between align-items-center text-blue-d2">
        ...
        <a href="<?php echo e(route('view_patient',[$doctor_info->id,$patient->id])); ?>"
    ...
    <div class="   px-0 mt-5">
        ...
        <div class="row d-print-inline-flex ">
            <div class="col-sm-4">
                <div>
                    <span class="fw-bold">To:</span><?php echo e($doctor_info->name); ?>
            ...
            <div class="col-sm-4 text-center">
                ...
                <?php else: ?>
                    <img src="<?php echo e(asset ('uploads/Barcode/'.$doctor_info->bar_image)); ?>" alt="Qr" class="img-fluid"
                    ...
                    <div class="text-95 text-secondary-d3">
                        <?php $__currentLoopData = $treatment_infos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$treatment_info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="row mb-2 mb-sm-0 py-25">
                                ...
                                <div class="col-9 col-sm-3"><?php echo e($treatment_info->treatment_plans); ?></div>
                        ...
                        <div class="row mb-2 mb-sm-0 py-25  ">
                            ...
                            <div class="d-none d-sm-block col-2 text-95">
                                Total Treatment Cost <br> ৳ <?php echo e($total_cost); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" name="t_plan_id" id="t_plan_id">
                            ...
                            <?php $__currentLoopData = $treatment_invoice_infos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $treatment_invoice_info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option
                                    value="<?php echo e($treatment_invoice_info -> id); ?>"><?php echo e($treatment_invoice_info -> treatment_plans); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="mb-3">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('treatment_discount')); ?>" method="post">
                    ...
                    <div class="mb-3">
                        <input type="hidden" class="form-control" list="list" name="p_mobile" value="<?php echo e($patient->mobile); ?>" readonly>
                    </div>
                    <div class="mb-3">
...
<?php /**PATH C:\xampp\htdocs\resources\views/invoice.blade.php ENDPATH**/ ?>