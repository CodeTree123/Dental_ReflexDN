<?php echo $__env->make('include.adminheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <main class="admin">
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
            ...
            <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link text-white text-center bg-dark my-2" id="v-pills-doctor-tab" data-bs-toggle="pill"
                   data-bs-target="#v-pills-doctor" type="button" role="tab" aria-controls="v-pills-doctor"
                   aria-selected="true">Doctor's Profile</a>

                <a class="nav-link text-white text-center bg-dark my-2" id="v-pills-subscription-tab"
                   data-bs-toggle="pill" data-bs-target="#v-pills-subscription" type="button" role="tab"
                   aria-controls="v-pills-subscription" aria-selected="false">Subscription</a>

                <a class="nav-link text-white text-center bg-dark my-2" id="v-pills-cc-tab" data-bs-toggle="pill"
                   data-bs-target="#v-pills-cc" type="button" role="tab" aria-controls="v-pills-cc"
                   aria-selected="false">C/C Cheif Complaints</a>

                <a class="nav-link text-white text-center bg-dark my-2" id="v-pills-cf-tab" data-bs-toggle="pill"
                   data-bs-target="#v-pills-cf" type="button" role="tab" aria-controls="v-pills-cf"
                   aria-selected="false">C/F Clinical Findings</a>

                <a class="nav-link text-white text-center bg-dark my-2" id="v-pills-investigation-tab"
                   data-bs-toggle="pill" data-bs-target="#v-pills-investigation" type="button" role="tab"
                   aria-controls="v-pills-investigation" aria-selected="false">Investigation</a>

                <a class="nav-link text-white text-center bg-dark my-2" id="v-pills-tp-tab" data-bs-toggle="pill"
                   data-bs-target="#v-pills-tp" type="button" role="tab" aria-controls="v-pills-tp"
                   aria-selected="false">T/P Treatment Plans</a>

                <a class="nav-link text-white text-center bg-dark my-2" id="v-pills-medicine-tab" data-bs-toggle="pill"
                   data-bs-target="#v-pills-medicine" type="button" role="tab" aria-controls="v-pills-medicine"
                   aria-selected="false">Medicine</a>

                <a class="nav-link text-white text-center bg-dark my-2" id="v-pills-notice-tab" data-bs-toggle="pill"
                   data-bs-target="#v-pills-notice" type="button" role="tab" aria-controls="v-pills-notice"
        ...
        <div class="tab-content m-5 w-100" id="v-pills-tabContent">
                    ...
                    <div class="col-lg-12 mt-1">
                        <ul class="nav nav-tabs doctor_profile_setting" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="Verified-Doctor-tab" data-bs-toggle="tab"
                                        data-bs-target="#Verified-Doctor" type="button" role="tab"
                                        aria-controls="Verified-Doctor" aria-selected="true">Verified Doctors
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="Unverified_Doctors-tab" data-bs-toggle="tab"
                                        data-bs-target="#Unverified_Doctors" type="button" role="tab"
                                        aria-controls="Unverified_Doctors" aria-selected="false">Unverified Doctors
                                </button>
                            </li>
                        </ul>
                    </div>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="Verified-Doctor" role="tabpanel"
                            ...
                            <table class="table table-bordered mt-4 text-center">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $varified_doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$v_doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($key+1); ?></td>
                                        <td><?php echo e($v_doctor->fname." ".$v_doctor->lname); ?></td>
                                        <td><?php echo e($v_doctor->BMDC); ?></td>
                                        <td><?php echo e($v_doctor->phone); ?></td>
                                        <td><?php echo e($v_doctor->email); ?></td>
                                        <td>
                                            <?php if($v_doctor->status == 1): ?>
                                        ...
                                        <td class="d-flex justify-content-around">
                                            ...
                                            <button class="btn crud-btns delete-doctor" href="#"
                                                    value="<?php echo e($v_doctor->id); ?>">
                        ...
                        <div class="tab-pane fade" id="Unverified_Doctors" role="tabpanel"
                            ...
                            <table class="table table-bordered mt-4 text-center">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $unvarified_doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($key+1); ?></td>
                                        ...
                                        <td>
                                            <?php if($doctor->verification == 1): ?>
                                                <a href="<?php echo e(route('doctor_verification',[$doctor->id])); ?>"
                                        ...
                                        <td class="d-flex justify-content-around">
                                            ...
                                            <button type="button" class="btn crud-btns unverified_Doctor_viewbtn"
                                                    href="" value="<?php echo e($doctor->id); ?>">
                                                <i class="fa-solid fa-file-lines"></i>
                                            </button>
                                            <button class="btn crud-btns delete-doctor" href="#"
                ...
                <table class="table table-bordered mt-4 text-center">
                    ...
                    <?php $__currentLoopData = $subscription_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$subscription_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($subscription_list->start); ?></td>
                            ...
                            <td>
                                <?php if($subscription_list->status == 1): ?>
                                    <a href="<?php echo e(route('subscription_status',[$subscription_list->id])); ?>"
                                       class="btn btn-sm btn-success my-0">Paid</a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('subscription_status',[$subscription_list->id])); ?>"
                            ...
                            <td class="d-flex justify-content-around">
                                ...
                                <button class="btn crud-btns delete-subscribtion" href="#"
                                        value="<?php echo e($subscription_list->id); ?>">
                                    <i class="fa-solid fa-trash"></i>
                                </button>
                            </td>
                        </tr>
            ...
            <div class="tab-pane fade" id="v-pills-investigation" role="tabpanel"
                 aria-labelledby="v-pills-investigation-tab">
                <div class="d-flex justify-content-between">
                    <h4 class="">
                        Investigation List
                    </h4>
                ...
                <table class="table table-bordered mt-4 text-center">
                    ...
                    <?php $__currentLoopData = $investigation_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$investigation_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="d-flex justify-content-around">
                                <button class="btn crud-btns Investigation_editbtn" href=""
                                        value="<?php echo e($investigation_list->id); ?>">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </button>
                                <button class="btn crud-btns delete-Investigation" href="#"
                                        value="<?php echo e($investigation_list->id); ?>">
                                    <i class="fa-solid fa-trash"></i>
                                </button>
                            </td>
            ...
            <div class="tab-pane fade" id="v-pills-medicine" role="tabpanel" aria-labelledby="v-pills-medicine-tab">
                <div class="d-flex justify-content-between">
                    ...
                    <a class="crud-btns me-2 add_medicine" href="" data-bs-toggle="modal"
                       data-bs-target="#Medicine_Add">
                        <i class="bi bi-plus-circle"></i>
                    </a>
                </div>
                <!-- Medicine List-->
                <table class="table table-bordered mt-4 text-center">
                    ...
                    <?php $__currentLoopData = $medicines_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$medicines_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="d-flex justify-content-around">
                                <button type="button" class="btn crud-btns Medicine_editbtn"
                    ...
                    <div class="modal-body">
                        <div class="form-floating ">
                            <input type="name" name="fname" class="form-control custom-form-control mb-2"
                                   placeholder="name@example.com" value="<?php echo e(old('name')); ?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('update_doctor')); ?>" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-floating ">
                            <input type="name" name="name" id="d_name" class="form-control custom-form-control mb-2"
                                   placeholder="name@example.com" value="<?php echo e(old('name')); ?>">
                            <label for="floatingInput">Name</label>
                        </div>

                        <div class="form-floating ">
                            <input type="email" name="email" id="d_email" class="form-control custom-form-control mb-2"
                                   placeholder="name@example.com" value="<?php echo e(old('email')); ?>">
                            <label for="floatingInput">Email address</label>
                        </div>
...
<div class="modal fade " id="del-Subscribtion" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <!-- Modal Body -->
            <div class="modal-body">
                <form action="<?php echo e(route('delete_subscription')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('delete'); ?>
                    <div class="mb-3 text-center">
                        <h5 class="text-danger">Are You Sure to Delete This information?</h5>
                    ...
                    <div class="modal-body">
                        <div class="mb-3 drug-name">
                            <input class="form-control" list="list" id="c_c_name"
                                   placeholder="Enter New Chief Complaint" name="cc_name">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-danger" data-bs-dismiss="modal">Discard</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('update_clinical_finding')); ?>" method="post">
                    ...
                    <div class="modal-body">
                        <div class="mb-3 drug-name">
                            <input class="form-control" list="list" id="c_f_name"
                                   placeholder="Enter New Clinical Finding" name="cf_name">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-danger" data-bs-dismiss="modal">Discard</button>
                ...
                <form action="<?php echo e(route('investigation')); ?>" method="post">
                    ...
                    <div class="modal-body">
                        <div class="mb-3 drug-name">
                            ...
                            <input type="hidden" name="investigation_status" id="investigation_status" value="1"
                                   readonly>
                        </div>
                    </div>
                    <div class="modal-footer">
                    ...
                    <div class="modal-body">
                        <div class="mb-3 drug-name">
                            <input class="form-control" list="list" id="Investigation_name"
                                   placeholder="Enter Investigation" name="investigation_name">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-danger" data-bs-dismiss="modal">Discard</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('update_treatment_plan')); ?>" method="post">
                    ...
                    <div class="modal-body">
                        <div class="mb-3 drug-name">
                            <input class="form-control" list="list" id="t_p_name"
                                   placeholder="Enter New Clinical Finding" name="tp_name">
                        </div>
                        <div class="mb-3 drug-name">
                            <input class="form-control" list="list" id="t_p_cost" placeholder="Enter Cost"
                                   name="tp_cost">
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal-content edit-medicine-info-modal">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('update_medicine')); ?>" method="post">
                    ...
                    <div class="modal-body">
                        <div class="mb-3 drug-name">
                            <input class="form-control" list="list" id="Medicine_name" placeholder="Enter Medicine Name"
                                   name="medicine_name">
                        </div>
                        <div class="mb-3 drug-name">
                            <input class="form-control" list="list" id="Medicine_brand"
                    ...
                    <?php $__currentLoopData = $redeems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$redeem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="d-flex justify-content-around  p-0">
                                ...
                                <button class="btn crud-btns delete-redeem" href="#" value="<?php echo e($redeem->id); ?>">
                                    <i class="fa-solid fa-trash"></i>
                                </button>
...
<?php /**PATH C:\xampp\htdocs\reflexdn\resources\views/admin_page.blade.php ENDPATH**/ ?>